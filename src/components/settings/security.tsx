                ...
                <div className="lg:col-span-7 space-y-10">
                    ...
                    <div className="bg-primary text-primary-foreground rounded-[32px] p-10 relative overflow-hidden group shadow-2xl shadow-primary/20">
                        <div className="relative z-10 space-y-6">
                            ...
                            <Button className="bg-card text-primary rounded-2xl h-14 px-8 font-medium uppercase text-[11px] tracking-widest hover:bg-card/90 shadow-2xl active:scale-95 transition-all">
                                Review Security
                            </Button>
                        </div>
                        ...
                        <div className="absolute top-0 left-0 w-full h-1 bg-card/10 blur-sm animate-pulse" />
                    </div>
                </div>
            </div>
